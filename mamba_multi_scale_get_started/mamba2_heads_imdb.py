...
Examples:
  ...
  python mamba2_heads_imdb.py --config configs/lstm_baseline.yaml
  python mamba2_heads_imdb.py --config configs/gru_baseline.yaml
...
@click.option(
    ...
    default=lambda: os.path.join(package_directory(), "configs", "mamba2_baseline_best.yaml"),
    show_default="configs/mamba2_baseline_best.yaml",
