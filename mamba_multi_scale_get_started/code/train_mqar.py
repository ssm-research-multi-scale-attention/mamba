...
def _mqar_log_startup_resolved(
    ...
    *,
    ...
    log_line(f"  model.multiscale.window_size: {_fmt_cfg_seq(cfg, 'model.multiscale.window_size')}")
    log_line(f"  model.multiscale.offsets: {_fmt_cfg_seq(cfg, 'model.multiscale.offsets')}")
    log_line(f"  model.multiscale.summary_mode: {_fmt_cfg_seq(cfg, 'model.multiscale.summary_mode')}")
    log_line(f"  model.multiscale.causal_mode: {_fmt_cfg_seq(cfg, 'model.multiscale.causal_mode')}")
    log_line(f"  model.multiscale.gate_type: {_fmt_cfg_seq(cfg, 'model.multiscale.gate_type')}")
